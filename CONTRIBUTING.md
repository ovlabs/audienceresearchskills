...
Thanks for your interest in contributing to Audience Research Skills! This guide will help you add new skills or improve existing ones.

## Requesting a Skill

You can suggest new skills by [opening a skill request](https://github.com/ovlabs/audienceresearchskills/issues/new?template=skill-request.yml).
...
- **Directory name**: lowercase, hyphens only (e.g., `deep-customer-research`)
...
- Add examples of `ask_twins` calls
...
- [ ] Audience descriptions are specific and detailed
